...
class AddSubtitles(BaseTool):
    ...
    def run(self) -> str:
        ...
        print(f"Detected text: {transcript.text[:100]}...")
        ...
        print(f"[OK] Extracted {len(words_with_timing)} words with timestamps")
        ...
        print(f"[OK] Created {len(chunks)} subtitle chunks")
        ...
        def create_text_image(text, font_size, width, color):
            ...
            if font is None:
                print("Warning: Could not load Montserrat font, using default")
        ...
        for i, chunk in enumerate(chunks):
            ...
            try:
                ...
                print(
                    f"Warning: Could not create subtitle for chunk {i + 1} ('{text[:30]}...'): {e}"
                )
                continue

        print(f"[OK] Successfully created {len(subtitle_clips)} subtitle clips")
        ...
        print("\n[SUCCESS] Subtitles added successfully!")
